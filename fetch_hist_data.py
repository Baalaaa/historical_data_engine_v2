...
class FetchHistoricalData:
    ...
    #
    #         for i in range(3):
    #             # logger.info(f"Failed symbol: {failed_data_sym_list} & count: {len(failed_data_sym_list)} !")
    ...
    #                 else:
    #                     retry_failed_sym_list.append(sym)
    #
    #         # failed_data_sym_list = retry_failed_sym_list.copy()
